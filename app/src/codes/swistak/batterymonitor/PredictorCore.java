...
class PredictorCore {
    ...
    static final int RECHARGE_AC  = 1;
    static final int RECHARGE_WL  = 2;
    static final int RECHARGE_USB = 3;

    static final int ONE_MINUTE      = 60 * 1000;
    static final int FIVE_MINUTES    = ONE_MINUTE *  5;
    static final int TEN_MINUTES     = ONE_MINUTE * 10;
    static final int FIFTEEN_MINUTES = ONE_MINUTE * 15;
    static final int THIRTY_MINUTES  = ONE_MINUTE * 30;
    static final int ONE_HOUR        = ONE_MINUTE * 60;
    static final int TWO_HOURS       = ONE_HOUR *  2;
    static final int THREE_HOURS     = ONE_HOUR *  3;
    static final int FOUR_HOURS      = ONE_HOUR *  4;
    static final int SIX_HOURS       = ONE_HOUR *  6;
    static final int EIGHT_HOURS     = ONE_HOUR *  8;
    static final int TWELVE_HOURS    = ONE_HOUR * 12;
    static final int ONE_DAY         = ONE_HOUR * 24;

    static final int SINCE_STATUS_CHANGE = -1;
    static final int LONG_TERM = -2;
    static final int AUTOMAGIC = -3;
    ...
    int cur_charging_status; // TODO make getters and make private

    PredictorCore(float ave_discharge, float ave_recharge_ac, float ave_recharge_wl, float ave_recharge_usb) {
    ...
    void update(BatteryInfo info, long when) {
